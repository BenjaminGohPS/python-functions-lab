...
def calculate_tip(bill, tip):
    tips = int(tip)
    return int(bill * tips/100)

# print('Exercise 7:', calculate_tip(50, 20))
# print('Exercise 7:', calculate_tip(50, 25))
...
def basic_calculator(num1, num2, string):
    if string == 'add':
        return num1 + num2
        ...
        return(f"{string} is an invalid command. Please key 'add', 'substract', 'multiply', 'divide'.")
